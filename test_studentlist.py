...
from studentlist import ClassList, StudentError
...
class TestStudentLists(TestCase):
    ...
    def test_remove_student_not_in_list(self):
        ...
        test_class.add_student("Katherina")
        test_class.add_student("Ulrich")
        test_class.add_student("Noah")
        self.assertRaises(StudentError, test_class.remove_student, "Adam")
    ...
    def test_not_enrolled(self):
        ...
        test_class.add_student("Valeria")
        self.assertFalse(test_class.is_enrolled("Mikkel"))
    ...
    def test_index_of_student_returns_none_empty_list(self):
        test_class = ClassList(5)
        self.assertIsNone(test_class.index_of_student("Martha"))
    ...
    def test_index_of_student_returns_none(self):
        test_class = ClassList(5)
        test_class.add_student('Taylor Swift')
        test_class.add_student('Kanye West')
        self.assertIsNone(test_class.index_of_student("Ulrich nelson"))
    ...
    def test_is_class_full(self):
        test_class = ClassList(3)
        test_class.add_student("Ulrich nelson")
        test_class.add_student('Taylor Swift')
        test_class.add_student('Kanye West')
